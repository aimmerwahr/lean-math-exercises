...
/-- The solution set of `f x = w` is a coset of the kernel. -/
...
/-- On a finite-dimensional space, an operator is injective iff surjective. -/
...
/-- No injective map into a strictly lower-dimensional space. -/
...
/-- The first-coordinate projection is idempotent but neither injective nor surjective. -/
...
/-- The projection `ℝ³ → ℝ²` is surjective but not injective. -/
