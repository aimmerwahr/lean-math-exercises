...
/-- Multiplicativity, checked by computing both sides. -/
...
/-- Vandermonde determinants factor as products of node differences. -/
...
/-- Invertibility via a nonzero determinant. -/
